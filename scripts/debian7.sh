...
case "$PACKER_BUILDER_TYPE" in
		...
		apt-get --purge -y autoremove cpp-4.7 gcc kpartx libgmp10 libmpc2 libmpfr4 $headers make
	...
	virtualbox-iso)
		# Remove Debian's outdated version of the VirtualBox additions.
		apt-get --purge -y autoremove virtualbox-guest-utils
		...
		# Remove development tools.
		apt-get --purge -y autoremove binutils bzip2 cpp cpp-4.7 gcc $headers libgmp10 libmpc2 libmpfr4 make
		...
		# Remove development tools.
		apt-get --purge -y autoremove cpp-4.7 gcc libclass-isa-perl libgmp10 libmpc2 libmpfr4 $headers make perl
